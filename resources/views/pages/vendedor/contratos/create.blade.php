<x-layout menu="orcamentos" submenu="todos_orcamentos">
    <form method="POST" enctype="multipart/form-data"
        ...
        <x-body title="Informações do Cliente do Financiamento"
            ...
            <div class="form-row">
                <div class="col-md-8">
                    <x-inputs.input label="Nome" type="text" name="nome"
                                    value="{{ getNomeCliente($orcamento->clientes_id) }}" required></x-inputs.input>
                </div>
                <div class="col-md-4">
                    <x-inputs.input label="Documento" type="text" name="documento"
                                    value="CPF nº " required></x-inputs.input>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <x-inputs.input label="Endereço" name="endereco" type="text" required></x-inputs.input>
                </div>
            </div>
        </x-body>
