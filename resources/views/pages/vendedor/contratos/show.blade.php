<x-layout menu="contratos" submenu="contratos-gerados">
    <x-body title="Contrato" class="m-md-5">
        <h3 style="text-align: center; margin-bottom: 30px">CONTRATO DE COMPRA E VENDA DE SISTEMA DE ENERGIA SOLAR</h3>
        <p>
            Pelo presente instrumento particular, as partes abaixo qualificadas:
        </p>
        <p>
            Vendedora: <strong>SOLMAR ENERGIA SOLAR</strong>, com sede à Av. Mandacarú, nº 4943, telefone (44) 99990-3092, inscrita no CNPJ sob nº 27.908.036/0001-24, doravante denominada
        ...
        <p>
            <strong>1. OBJETO:</strong> O presente contrato tem por objeto a venda e instalação de um sistema de geração de energia solar fotovoltaico, conforme proposta
            comercial aprovada pelo COMPRADOR.
        </p>
        <p>
            <strong>2. PRAZO DE ENTREGA:</strong> A VENDEDORA compromete-se a realizar a entrega e instalação do sistema no prazo acordado entre as partes, contado a
            partir da assinatura deste contrato e do pagamento inicial.
        </p>
        <p>
            <strong>3. GARANTIA:</strong> Os equipamentos fornecidos possuem garantia de fábrica de acordo com o fabricante, e a instalação possui garantia de 12 (doze)
        ...
        <p>
            <strong>6. DISPOSIÇÕES GERAIS:</strong> Este contrato passa a vigorar a partir da data de sua assinatura. Os casos omissos serão resolvidos de comum acordo
            entre as partes.
        </p>
