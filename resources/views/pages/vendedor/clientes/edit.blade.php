<x-layout menu="clientes">
    <x-body title="Editar Informações" url-button="{{ route('vendedor.clientes.index') }}">
        <form method="POST" action="{{ route('vendedor.clientes.update', $cliente->id) }}"> @csrf @method('put')
            <h5>Pessoa Física</h5>
            <div class="form-row">
                <div class="col-md-6">
                    <x-inputs.input label="Nome" name="nome" type="text" value="{{ $cliente->nome }}"
            ...
            <div class="form-row">
                <div class="col-md-3">
                    <x-inputs.input label="Data de Nascimento" name="data_nascimento" id="data_nascimento" type="text"
            ...
            <div class="form-row">
                ...
                <div class="col-md-4">
                    <x-inputs.input label="Email" name="email" type="email"
                                    value="{{ $dados['email'] ?? '' }}"></x-inputs.input>
                </div>
            </div>
            <hr>
            ...
            <div class="form-row">
                <div class="col-12">
                    <x-inputs.textarea label="Anotações" name="anotacoes"
                                       id="anotacoes" type="text">{{ $dados['anotacoes'] ?? '' }}</x-inputs.textarea>
