<x-layout menu="kits_fv" submenu="cadastrar_kit_fv">
    <x-body title="Cadastro de Kit Fotovoltaicos">
        <form method="POST" action="{{ route('admin.produtos.kits.store') }}"> @csrf
            <div class="row">
                <div class="col">
                    <x-inputs.input label="Modelo do Kit Fotovoltaico" type="text" name="modelo" value="" required></x-inputs.input>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col">
                    <x-inputs.textarea label="Produtos do Kit" name="produtos" value="" rows="10" required></x-inputs.textarea>
                </div>
            </div>
            <div class="row">
                <div class="col">
