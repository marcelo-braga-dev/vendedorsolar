<x-layout menu="usuarios" submenu="vendedores">
    @push('css')
        <style>
            ...
            .table-modern td .mono{ font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace; }
            .table-modern .col-actions{ width: 120px; text-align: right; }
            .badge-pill{
            ...
            .btn-icon-warning{
                color:#fd7e14; border-color:#fd7e14; background:#fff;
            }
            .btn-icon-warning:hover{ color:#fff; background:#fd7e14; border-color:#fd7e14; }
