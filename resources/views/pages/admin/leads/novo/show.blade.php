<x-layout menu="leads" submenu="">
    <x-body title="Informações do Leads NOVO" url-button="{{ route('admin.leads.index') }}">
        <div class="row mb-3">
            <div class="col-md-6">
        ...
        <form method="POST" action="{{ route('admin.leads.update', $lead->id) }}"> @csrf @method('PUT')
            <div class="row">
                <div class="col-md-6">
                    <x-inputs.select label="Vendedor responsável: " name="vendedor">
                        <option></option>
