...
class DadosDimensionamento extends Model
{
    ...
    public function setMargemPerda(string $margemPerda): void
    {
        $this->newQuery()
            ->updateOrInsert(
    ...
    public function setSobraPotencia(string $sobraPotencia): void
    {
        $this->newQuery()
            ->updateOrInsert(
    ...
    public function setPerdaNordesteNoroeste(string $perdaNordesteNoroeste): void
    {
        $this->newQuery()
            ->updateOrInsert(
    ...
    public function setPerdaLesteOeste(string $perdaLesteOeste): void
    {
        $this->newQuery()
            ->updateOrInsert(
    ...
    public function setPerdaSudesteSudoeste(string $perdaSudesteSudoeste): void
    {
        $this->newQuery()
            ->updateOrInsert(
    ...
    public function setPerdaSul(string $perdaSul): void
    {
        $this->newQuery()
            ->updateOrInsert(
