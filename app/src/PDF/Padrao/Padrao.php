...
use App\src\PDF\Padrao\Sessoes\Assinaturas;
use App\src\PDF\Padrao\Sessoes\Beneficios;
use App\src\PDF\Padrao\Sessoes\Capa;
use App\src\PDF\Padrao\Sessoes\Graficos;
use App\src\PDF\Padrao\Sessoes\Imagenskit;
use App\src\PDF\Padrao\Sessoes\InfoKit;
use App\src\PDF\Padrao\Sessoes\InfoPredio;
use App\src\PDF\Padrao\Sessoes\Introducao;
use App\src\PDF\Padrao\Sessoes\Portfolio;
use App\src\PDF\Padrao\Sessoes\Regulamentacao;
use Mpdf\Mpdf;
use Mpdf\MpdfException;

class Padrao extends DadosOrcamento
{
    public Mpdf $mpdf;
